...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "bowenhuang-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/bowen"
  #   chef.validation_client_name = "bowen-validator"
  #   chef.validation_key_path = ".chef/bowen-validator.pem"
  # end
end
